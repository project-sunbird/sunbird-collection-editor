...
describe('collection service', function () {
	...
	it('Should initialize the context menu', function () {
		...
		org.ekstep.services.collectionService.initContextMenuDropDown()
	...
	it('Should drop the selected node', function () {
		...
		org.ekstep.services.collectionService._dropNode(node, data)
	...
	it('Should log the telemetry', function () {
		...
		org.ekstep.services.collectionService.__telemetry({})
